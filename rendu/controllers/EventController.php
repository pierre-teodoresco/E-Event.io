        ...
        if(isset($_GET['id'])){
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if($_POST['action'] == "addcontent"){
                     ...
                     */
                    $point = $_POST['givepoint'];
                    $comment = $_POST['adddecs'];
                    $this->model->addAdd($point, $comment, $_GET['id']);
                    header('Location: ?controller=event&action=index&id=' . $_GET['id']);
                    return;
                }
            }
            ...
            if($i>0){
                 ...
                 */
                $additionnalContent2 = $this->model->getAdditionnalContentOfEvent($_GET['id']);
            ...
            if($_SESSION['id'] == $this->model->getAttribute('owner', $_GET['id'])){
                ...
                <a id=\"myBtn2\" class=\"button\">Rajouter un contenu</a>
                    </div>";
            }
            $dataEvent .= "</div>";
            ...
            if($_SESSION['username'] != "" && ($_SESSION['role'] == 4 || $_SESSION['role'] == 2)){
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $data['event-desc'] = $_POST['event-desc'];
                    $data['event-content'] = $_POST['event-content'];
                     ...
                     */
                    $this->model->createEvent($_SESSION['id'], $data['event-title'],$data['event-desc'],$data['event-content']);
