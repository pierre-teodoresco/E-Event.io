...
<div class="flexContainer">
    ...
    <div class="feed">
        ...
        $sql1 = "SELECT title, owner, description, content, votes, ilustration, addcontent, username,image_profile FROM evenement INNER JOIN account ON owner = account.id WHERE evenement.id = '$id'";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<h4>Authuer : $row[username]</h4>";
                echo "<img src=\"img/$row[image_profile]\" width='100px' height='100px' style='border-radius: 50%'>";
                ...
                echo "Nombre de vote : $row[votes]";
                echo "   <h4>Commentaires : </h4>";

                        $sql2 = "SELECT author,description, username FROM comment INNER JOIN account ON author = account.id WHERE comment.event = '$id'";
            ...
            echo "Aucun articles ne correspond à l'id";
        }
        ?>
...
<div id="myModal" class="modal">
    ...
    <form action="verif.php.php" method="post">
        <!-- Modal content -->
