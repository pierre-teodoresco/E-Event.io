        ...
        <nav>
            <?php if($username != ""){ ?>
                <div class="navbar-extern">
                    <a>
                        <div class="statement">
                            <img src="img/<?php echo $avatar;?>" alt="" width="32", height="32" class="icon">
            ...
            <div class="navbar">
                ...
                <?php if(($role == 2 || $role == 4) && $isCampagne == '1' ){?>
                    <a id="myBtn">
                        <div class="statement">
                            ...
                            <h3 class="navbar-title">Créer un evenement</h3>
                        </div>
                    </a>
                <?php }?>
                <?php if($role == 4){ ?>
...
<?php if(($role == 2 || $role == 4)&& $isCampagne == '1'){ ?>
    <div id="myModal" class="modal">
        ...
        <form method="post" id="createEvent" enctype="multipart/form-data">
            <!-- Modal content -->
            <div class="modal-content">
                <div class="modal-header">
                    <div class="modal-title">Création d'évènement</div>
                    <span class="close">&times;</span>
                </div>
                <div class="modal-body">
                    <?php echo $data['errorevent-title']?>
                    <label for="event-title">Création d'évènement</label>
                    ...
                    <div class="photo">
                        <input type="file" id="event-img" name="event-img" accept="image/*">
                    </div>
                </div>
                <div class="modal-footer">
                    <a a href="javascript:;" onclick="document.getElementById('createEvent').submit();"  class="button">Créer mon évènement</a>
                </div>
            </div>
        </form>
    </div>
