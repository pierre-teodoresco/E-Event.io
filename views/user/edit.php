    ...
    <nav>
        <?php if($username != ""){ ?>
            <div class="navbar-extern">
                <a  >
                    <div class="statement">
                        <img src="img/<?php echo $img;?>" alt="" width="32", height="32" class="icon">
    ...
    <div class="feed">
        <form method="post" id="editplayer" enctype="multipart/form-data">
            <div class="container" >
                ...
                <p>Photo de profil</p>
                <div class="photo">
                    <img src="img/<?php  echo $img?>" name="profile" id="profile" alt="Avatar" class="avatar">
                    <input type="file" id="avatar" name="avatar" accept="image/*">
                </div>
                <p>Mot de passe</p>
                <?php echo $errorOldpassword; ?>
                <input type="password" name="oldpassword" id="oldpassword" placeholder="Ancien mot de passe"  >
                <?php echo $errorPassword; ?>
                <input type="password" name="password" id="password" placeholder="Nouveau mot de passe" >
                <?php echo $errorPasswordc; ?>
