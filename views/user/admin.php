        ...
        <div class="navbar-extern">
            <a href="<?php echo($username != "") ?"?controller=user&action=edit" : "?controller=user&action=login" ?>">
                <div class="statement">
                    ...
                    <h3 class="navbar-title"><?php echo($username != "") ?"Modifier mon profile" : "Se connecter" ?></h3>
                </div> 
            </a>   
        </div>
        <div class="navbar">
    ...
    <form method="post" id="formcamp">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">Création d'une nouvelle campagne</div>
            ...
            <div class="modal-body">
                ...
                <label for="campagne-start">Dâte de début</label>
                ...
                <label for="campagne-end">Dâte de fin</label>
