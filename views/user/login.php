<div class="auth">
    ...
    <div class="left">
        ...
        <p>Entité de soutien lors de l'organisation d'événements, notamment pour les étudiants d'Aix-Marseille Université</p>
    </div>
    <form method="post" id="login" class="right">
        ...
        <a href="?controller=user&action=forgot" class="center">Mot de passe oublié ?</a>
